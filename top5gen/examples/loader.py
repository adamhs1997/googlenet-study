...
sys.path.append('../')
from top5gen.src.dataflow.images import Image
from top5gen.src.dataflow.cifar import CIFAR 
...
def load_label_dict(dataset='imagenet'):
    ...
    label_dict = {}
    if dataset == 'cifar':
        file_path = 'top5gen/data/cifarLabel.txt'
    else:
        file_path = '/home/w266ajh/Documents/top5gen/data/imageNetLabel.txt'
